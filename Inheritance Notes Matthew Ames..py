...
class Car(Vehicle):
    ...
    def roll_down_windows(self):
        print("You rolled the windows down.")

    def turn_on(self):
        print("You turn the key and the engine starts.")


test_car = Car('Aluminiun', 'Driver Side', 140, 2, True)
...
test_car.turn_on()
cool_car = KeylessCar('Krabby Patty', 'Driver Side', 140, 2, True)
cool_car.turn_on()
...
class Tesla(Car):
    ...
    def fly(self):
        print("You launch the car into space.")
